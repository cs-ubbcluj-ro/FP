...
'''
    ...
    NB! 
        This is not necessarily the correct way to implement error handling, it's just example code.
'''
end = False
while not end:
    try:
        val = input("T - TypeError, V - ValueError, K - KeyError, 0 - Exit")
        ...
        print(
            "The finally block always runs. This is useful for deallocating resources such as closing files, network connections and so on.")
